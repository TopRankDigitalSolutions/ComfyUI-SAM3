...
def try_install_torch_generic_nms():
    ...
    print("[ComfyUI-SAM3] Compiling torch_generic_nms from source (may take several minutes)...")
    ...
    try:
        result = subprocess.run(
            ...
            capture_output=True,
            text=True,
            timeout=600,  # Increased timeout for compilation (10 minutes)
            env=cuda_env
        )
...
def try_install_cc_torch():
    ...
    print("[ComfyUI-SAM3] Compiling cc_torch from source (may take several minutes)...")
